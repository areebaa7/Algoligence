...
export default function Hero() {
  return (
    <section className="min-h-[85vh] relative overflow-hidden flex items-center bg-[#0A0F2C]">
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        ...
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-6xl lg:text-7xl font-extrabold leading-[1.05]">
            {words.map((word, i) => (
              <motion.span
                key={i}
                className="inline-block mr-3 bg-gradient-to-r from-blue-400 via-blue-300 to-[#ABC4FF] bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(171,196,255,0.35)]"
